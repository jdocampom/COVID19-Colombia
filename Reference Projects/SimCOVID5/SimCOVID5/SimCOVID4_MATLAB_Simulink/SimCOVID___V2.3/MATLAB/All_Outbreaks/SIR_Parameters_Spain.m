...
% Case: Spain Outbreak
function [Parameters] = SIR_Parameters_Spain
N   = 47*10^6;                       % Population
st1 = 29; st2 = 51;                  % Step times for the sigmoid function (chosen empirically by observing Cm plot)
x0  = [N/1; 3; 0; ];                % Initial values for the states (S,I,R) used in 'ode45'
[Parameters] = SIR_Model;
    function [Parameters] = SIR_Model
        I1  = xlsread('COVID-19-geographic-disbtribution-worldwide-2020-04-25','Spain','E:E');
        Im  = flip(I1);  Im=Im(57:end);            %  Neglecting zero elements
