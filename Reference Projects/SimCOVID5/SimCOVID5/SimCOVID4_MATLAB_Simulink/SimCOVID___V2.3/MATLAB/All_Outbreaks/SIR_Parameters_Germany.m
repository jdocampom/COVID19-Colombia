...
% Case: Germany Outbreak
function [Parameters] = SIR_Parameters_Germany
N   = 83*10^6;                       % Population
st1 = 24; st2 = 41;                  % Step times for the sigmoid function (chosen empirically by observing Cm plot)
x0  = [N/1; 17; 0; ];                % Initial values for the states (S,I,R) used in 'ode45'
[Parameters] = SIR_Model;
    function [Parameters] = SIR_Model
        I1  = xlsread('COVID-19-geographic-disbtribution-worldwide-2020-04-25','Germany','E:E');
        Im  = flip(I1);  Im=Im(57:end);            %  Neglecting zero elements considering 14 starting-cases (I0=14)
        Cm  = cumsum(Im);                          %  Cumulative sum of I
        tm  = 1:length(Cm);                        %  Time (day)
        %=============================Curve Fitting========================
        Parameters0 = [23; 23; 23; 0.1; 23];    % Initial values for 'lsqcurvefit'
