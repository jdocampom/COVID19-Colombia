...
isModelOpen = bdIsLoaded('SIR_Italy_ConstantGamma1'); % We need this later on to close the parallel loop
open_system('SIR_Italy_ConstantGamma1');
beta_new=1;
beta_step = beta_new*[0.975 1 1.025];   % These are normalized beta changes (10%)
numSims = length(beta_step);
for i = numSims:-1:1
    in(i) = Simulink.SimulationInput('SIR_Italy_ConstantGamma1');
    in(i) = in(i).setBlockParameter('SIR_Italy_ConstantGamma1/Value2', 'Value', num2str(beta_step(i)));
end
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Sigmoidal MF1','a',num2str(-a));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Sigmoidal MF1','c',num2str(st1));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Sigmoidal MF2','a',num2str(a));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Sigmoidal MF2','c',num2str(st1));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Sigmoidal MF3','a',num2str(a));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Sigmoidal MF3','c',num2str(st2));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/gamma','Value',num2str(gamma));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/beta1','Gain',num2str(beta1));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/beta2','Gain',num2str(beta2));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/beta3','Gain',num2str(beta3));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/g','Gain',num2str(g));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Value1','Value',num2str(1));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Switch','Threshold',num2str(st3));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/Population','Value',num2str(P));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/I0','Value',num2str(I0));
in = in.setBlockParameter('SIR_Italy_ConstantGamma1/R0','Value',num2str(R0));
...
if(~isModelOpen)
    close_system('SIR_Italy_ConstantGamma1', 0);
end
