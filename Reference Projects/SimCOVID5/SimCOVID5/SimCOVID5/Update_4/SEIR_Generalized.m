...
% Keynote 2: You can switch between the methods of "findchangepts" @line-35 ("rms", "linear", "std", or "mean"). You can also change the simulation length @line-44 to  get more time line view of the prediction.
