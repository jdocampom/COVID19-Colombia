% SimCOVID Version 5.0 (generalized SEIR Model, Short-Term)
...
%==========================================================================
function Parameters = SEIR_Short_Term
clc;
...
COVID19_Data = readtable('COVID-19-geographic-disbtribution-worldwide-2020-05-30', 'ReadVariableNames', true);
...
betag = [0.97 1.0 1.03];                                              % Beta change at time zero.
for k = 1:3
...
%============Solving SEIR with One Output (Needed for lsqcurvefit)=========
    function SEIRout1 = SolveSEIR1(Parameters,Simulated_t)
        ...
        function dSEIR=DEs(Simulated_t,x)
            ...
            betaf    = (betaf1+betaf2+betaf3)*(1.01-Simulated_t/Simulation_length);                               % Infection rate
