...
x0  = [N/1; 1; 0; ];                 % Initial values for the states (S,I,R) used in 'ode45'
[Parameters] = SIR_Model;
    function [Parameters] = SIR_Model
        ...
        Im  = flip(I1);  Im=Im(32:end);            %  Neglecting zero elements considering 1 starting-cases (I0=1)
        Cm  = cumsum(Im);                          %  Cumulative sum of I
        tm  = 1:length(Cm);                        %  Time (day)
        %=============================Curve Fitting========================
        Parameters0 = [0.4; 0.32; 0.19; 1.44; 0.23];    % Initial values for 'lsqcurvefit'
