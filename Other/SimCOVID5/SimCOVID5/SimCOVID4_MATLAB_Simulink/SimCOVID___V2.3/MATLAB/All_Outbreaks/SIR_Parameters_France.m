...
% Case: France Outbreak
function [Parameters] = SIR_Parameters_France
N   = 67*10^6;                       % Population
st1 = 27; st2 = 41;                  % Step times for the sigmoid function (chosen empirically by observing Cm plot)
x0  = [N/1; 14; 0; ];                % Initial values for the states (S,I,R) used in 'ode45'
[Parameters] = SIR_Model;
    function [Parameters] = SIR_Model
        I1  = xlsread('COVID-19-geographic-disbtribution-worldwide-2020-04-25','France','E:E');
        Im  = flip(I1);  Im=Im(58:end);            %  Neglecting zero elements considering 14 starting-cases (I0=14)
