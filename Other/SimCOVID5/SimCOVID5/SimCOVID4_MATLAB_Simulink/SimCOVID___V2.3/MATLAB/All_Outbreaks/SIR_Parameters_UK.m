...
% Case: UK Outbreak
function [Parameters] = SIR_Parameters_UK
N   = 66*10^6;                       % Population
st1 = 18; st2 = 25;                  % Step times for the sigmoid function (chosen empirically by observing Cm plot)
x0  = [N/1; 15; 0; ];                % Initial values for the states (S,I,R) used in 'ode45'
[Parameters] = SIR_Model;
    function [Parameters] = SIR_Model
        I1  = xlsread('COVID-19-geographic-disbtribution-worldwide-2020-04-25','UK','E:E');
        Im  = flip(I1);  Im=Im(59:end);            %  Neglecting zero elements considering 14 starting-cases (I0=14)
        Cm  = cumsum(Im);                          %  Cumulative sum of I
        tm  = 1:length(Cm);                        %  Time (day)
        %=============================Curve Fitting========================
        Parameters0 = [1; 1; 1; 0.25; 0.01];    % Initial values for 'lsqcurvefit'
        ...
        ub = 1*[ 1; 1; 1; 1; 1];                    % maximum values for the parameters (optional)
