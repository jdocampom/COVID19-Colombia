...
isModelOpen = bdIsLoaded('Program_1_SIR_Italy_R2018a'); % We need this later on to close the parallel loop
open_system('Program_1_SIR_Italy_R2018a');
beta_new=1;
beta_step = beta_new*[0.95 1 1.05];   % These are normalized beta changes (10%)
numSims = length(beta_step);
for i = numSims:-1:1
    in(i) = Simulink.SimulationInput('Program_1_SIR_Italy_R2018a');
    in(i) = in(i).setBlockParameter('Program_1_SIR_Italy_R2018a/value2', 'Value', num2str(beta_step(i)));
end
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/Sigmoidal MF1','a',num2str(-a));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/Sigmoidal MF1','c',num2str(st1));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/Sigmoidal MF2','a',num2str(a));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/Sigmoidal MF2','c',num2str(st1));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/Sigmoidal MF3','a',num2str(a));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/Sigmoidal MF3','c',num2str(st2));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/zeta1','Gain',num2str(zeta1));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/zeta2','Gain',num2str(zeta2));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/zeta3','Gain',num2str(zeta3));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/gamma1','Gain',num2str(gamma1));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/gamma2','Gain',num2str(gamma2));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/gamma3','Gain',num2str(gamma3));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/beta','Gain',num2str(beta));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/value1','Value',num2str(1));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/Switch','Threshold',num2str(st3));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/Population','Value',num2str(P));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/I0','Value',num2str(I0));
in = in.setBlockParameter('Program_1_SIR_Italy_R2018a/R0','Value',num2str(R0));
...
if(~isModelOpen)
    close_system('Program_1_SIR_Italy_R2018a', 0);
end
