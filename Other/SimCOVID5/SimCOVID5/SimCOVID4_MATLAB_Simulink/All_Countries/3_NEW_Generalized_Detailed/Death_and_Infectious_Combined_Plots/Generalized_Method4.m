...
%==========================================================================
function Parameters = Generalized_Method4
clc;
...
Simulated_SIR=zeros(length(Simulated_t),n);
for k = 1:n
    ...
    function [tout, SIRout1] = SolveSIR2(Parameters,Simulated_t)
        ...
        function dSIR=DEs(Simulated_t,x)
            ...
            if Simulated_t < length(Cm)
                ...
                betag=ones(1,n).*[0.95 0.975 1.025 1.05 1 ];                                         % This is the change percentage of the beta function
            end
            dxdt    = zeros(4,1);
