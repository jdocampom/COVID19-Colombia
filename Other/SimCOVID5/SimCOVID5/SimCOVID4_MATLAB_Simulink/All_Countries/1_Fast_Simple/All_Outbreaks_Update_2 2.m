...
% Note 3: The lower bounds for the parameters are equal or greater than zero except for the sigmoid parameter a. Changing the upper bound limits can affect the solution and the time to solve the problem.
...
%==========================================================================
function [Parameters] = All_Outbreaks_Update_2
SearchCountry = 'united_states_of_america';   % Enter the country name here (case insensitive) and run. Use under-line dash "_" for a name with more than one part (ex: Saudi_Arabia, saudi_arabia)
...
[Parameters] = SIR_Model;
    function [Parameters] = SIR_Model
        ...
        %     beta1  beta2  beta3  t1            t2          a   gamma
        lb = [ 0.01; 0.01;  0.01;  0;            0;          -1; 0.01];      % minimum values for the parameters (a must). The sigmoid parameter (a) can be negative
        ub = [ 10;   10;    10;    length(Cm)/2; length(Cm); 10; 1   ];      % maximum values for the parameters (optional)
...
%============Solving SIR with One Output (Needed for lsqcurvefit)==========
    function SIRout1 = SolveSIR1(Parameters,t)
        ...
        function dSIR=DEs(t,x)
            betaf1  = Parameters(1)*abs((sigmoid(t,0,            Parameters(6)) - sigmoid(t,Parameters(4),Parameters(6))));
...
%===============================Plotting R0================================
betaf1  = Parameters(1)*abs((sigmoid(Simulated_t,0,            Parameters(6)) - sigmoid(Simulated_t,Parameters(4),Parameters(6))));
